...
class RoomTest < MiniTest::Test
  ...
  # end
  #
  # def test_add_guest_to_occupants__succeeds
  #   assert_equal([@guest1, @guest2], @occupants)
  #   assert_equal(true, @room.add_guest_to_occupants(@guest6))
  #   assert_equal(100, @guest6.cash)
  #   assert_equal([@guest1, @guest2, @guest6], @occupants)
  # end
  #
  # def test_add_guest_to_occupants__fails
  #   assert_equal([@guest1, @guest2], @occupants)
  #   assert_equal(false, @room.add_guest_to_occupants(@guest7))
  #   assert_equal(40, @guest7.cash)
  #   assert_equal([@guest1, @guest2], @occupants)
  # end
  #
  # def test_remove_guest_from_rooms
  #   @room.remove_guest_from_rooms(@guest2)
  #   assert_equal([@guest1], @occupants)
  # end
  #
